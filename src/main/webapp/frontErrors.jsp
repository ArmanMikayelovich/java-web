...
<div class="error">
    <div class="container-floud">
        <div class="col-xs-12 ground-color text-center">
            ...
            <h2 class="h1">Unauthenticated. Need to login</h2>
            <% } else if (response.getStatus() == 403) {%>
            <h2 class="h1">Unauthorized.</h2>
            <% } else if (response.getStatus() == 404) {%>
            <h2 class="h1">Not found.</h2>
            <%} %>
        </div>
    </div>
</div>
...
<script>
    ...
    loop3 = setInterval(function () {
        ...
        if (i > 40) {
            clearInterval(loop3);
            selector3.textContent = <%=response.getStatus()/100%>;
        } else {
    ...
    loop2 = setInterval(function () {
        ...
        if (i > 80) {
            clearInterval(loop2);
            selector2.textContent =<%=response.getStatus()/10%10%>;
        } else {
    ...
    loop1 = setInterval(function () {
        ...
        if (i > 100) {
            clearInterval(loop1);
            selector1.textContent = <%=response.getStatus()%10%>;
        } else {
